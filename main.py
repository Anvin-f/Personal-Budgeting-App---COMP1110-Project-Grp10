...
--------------------------------------
 ...
 10. check-alerts: Run all rule-based alerts
 11. add-budget: Set or update a monthly budget for a tag
 12. list-budgets: List all budgets
 13. delete-budget: Delete a budget
...
def main():
    while True:
        ...
        elif choice in ["10", "check-alerts"]:
            cli.check_alerts()

        elif choice in ["11", "add-budget"]:
            cli.add_budget()

        elif choice in ["12", "list-budgets"]:
            cli.list_budgets()

        elif choice in ["13", "delete-budget"]:
            cli.delete_budget()
